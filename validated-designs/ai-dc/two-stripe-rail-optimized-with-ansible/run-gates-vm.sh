...
echo "== 4. fresh lab =="
sudo containerlab destroy -t two-stripe-rail-optimized-with-ansible.clab.yaml --cleanup 2>/dev/null || true
sudo containerlab deploy -t two-stripe-rail-optimized-with-ansible.clab.yaml   # expect 34 nodes
